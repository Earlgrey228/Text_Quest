...
public class Start extends AbstractRoom{
	...
	public void play(Player p) {
		...
		Log.out("\tВ тихом городке Балтач, на окраине, есть древний домик, где когда-то давным-давно жил и работал болгарский учёный.\n"+
			"По легенде, он работал с различными сущностями и искал способ найти контакт с джинном. |/| он смог найти этот контакт,\n" +
			...
			"\tНе все, всё же, верят в сказки. |/| наша компания друзей хочет развеять эту легенду раз и навсегда,\n" +
